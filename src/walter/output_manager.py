...
def log_Peraxes(Peraxes_dico_df, initialization_Flag,num_plt, elapsed_time, DOY, Temperature,
                Tempcum, axis, Sh_max_temp, Hcol_max, Hcol_dead, delta_H, tiller_surface, axis_census, leaf_contrib, stem_contrib, ear_contrib, peduncle_contrib ):
...
def log_Gai(GAI_dico_df, initialization_Flag, num, elapsed_time, Tempcum, DOY, surface_plante, surface_plante_visible, crop_scheme, GAI_tot, GAI_center, GAI_ind, GAI_prox):
